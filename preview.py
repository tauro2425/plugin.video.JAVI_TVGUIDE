...
def checkForAlternateStreaming(url):
	...
	if 'plugin.video.ZonaPremium' in url:
        print '****** Alternate JukeBox ******'
        print url
        return alternateStream(url)
        
    if 'plugin.video.p2p-streams' in url:
        print '****** Alternate Muzu ******'
        print url
        return alternateStream(url)
        
    if 'plugin.video.zonapremium2' in url:
        print '****** Alternate RAM FM ******'
        print url
        return alternateStream(url)
        
    if 'plugin.video.SportsDevil' in url:
        print '****** Alternate MashUp ******'
        print url
        return alternateStream(url)	
...
# plugin.video.zonapremium2
# plugin.video.p2p-streams
# plugin.video.ZonaPremium